...
public class Assignment5Q2 {
    ...
    public static void main(String[] args) {
        News news1 = new News(1, "Ajay", "Vijay", "comment");
        News news2 =new News(2, "Ajay1", "Vijay1", "budget");
        News news3 = new News(1, "Ajay2", "Vijay2", "comment");
        News news4 = new News(3, "Ajay3", "Vijay", "budget");
        News news5 = new News(1, "Ajay4", "Vijay4", "comment");
        News news6 = new News(3, "Ajay5", "Vijay5", "budget");
        News news7 = new News(1, "Ajay6", "Vijay6" ,"comment");
